...
public final class ALessSecondCondition extends PSecondCondition
{
    private PItem1 _item1_;
    private TLess _less_;
    private PItem2 _item2_;

    public ALessSecondCondition()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessSecondCondition(
    ...
    {
        ((Analysis) sw).caseALessSecondCondition(this);
    }
