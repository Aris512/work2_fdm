...
public final class AGreaterSecondCondition extends PSecondCondition
{
    private PItem1 _item1_;
    private TGreater _greater_;
    private PItem2 _item2_;

    public AGreaterSecondCondition()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterSecondCondition(
    ...
    {
        ((Analysis) sw).caseAGreaterSecondCondition(this);
    }
