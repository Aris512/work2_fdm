...
public final class ABlockBlockStatement extends PBlockStatement
{
    private TLbrace _lbrace_;
    private final LinkedList<PStatement> _statement_ = new LinkedList<PStatement>();
    private TRbrace _rbrace_;

    public ABlockBlockStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlockBlockStatement(
    ...
    {
        ((Analysis) sw).caseABlockBlockStatement(this);
    }
